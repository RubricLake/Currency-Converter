...
def convertCurrency():
    ...
    # Open JSON File with currency symbols.
    f = open('currencies.json','r', -1, 'utf-8')
    checkList = json.load(f)
    
    # Check if inputted currencies exist
...
# Amount of Origin Currency Field
